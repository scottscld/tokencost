...
// Presets: input tokens = what you send; output tokens = what AI replies
// These are averages per single request
const PRESETS = {
  chatbot:  { inputTok: 400,   outputTok: 200  },
  coding:   { inputTok: 3000,  outputTok: 2000 },
  content:  { inputTok: 600,   outputTok: 1000 },
  rag:      { inputTok: 5000,  outputTok: 500  },
  agent:    { inputTok: 8000,  outputTok: 3000 },
  image:    { inputTok: 200,   outputTok: 150  }, // "just exploring"
};
